...
import 'package:zenactive/controllers/message_controller.dart';
...
class _ConversationScreenState extends State<ConversationScreen> {
  ...
  void initState() {
    ...
    messageController.listenMessage(connectionId: widget.friend.connectionId!);
  ...
  @override
  void dispose() {
    messageController.closeListenMessage(
        connectionId: widget.friend.connectionId!);
    super.dispose();
  }
                              ...
                              for (int i = 0;
                                ...
                                ChatBubble(
                                  ...
                                  isMe: messageController.messages.value
                                      ...
                                      widget.friend.id,
                                  showTime: true,
                                  usravatar: imageUrl(messageController.messages
                                      .value.userChat![i].senderId!.image),
