...
class DownloadService extends GetxController {
  ...
  // Helper function to get the appropriate download directory based on the platform.
  ...
  Future<void> startDownload(String url, String? fileName) async {
    ...
    try {
      ...
      Get.snackbar("Download Failed", "Error URL Issue!");
  ...
  Future<void> requestPermissions() async {
    ...
    // iOS typically does not require additional storage permissions.
  }
}
